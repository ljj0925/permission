    ...
    <T> {
        ...
        <T>[] customRequire;
            ...
            <T>[] getCustomRequire() {
                ...
                public void setCustomRequire(WhereRequire
                <T>[] customRequire) {
                    ...
                    return "WhereRequire [require=" + require + ", value=" + value + ", values=" +
                    Arrays.toString(values) + ", suffix=" + suffix
                    ...
                    */
                    public
                    <T> Assist andEq(String column, T value) {
                        setRequires(new Assist().new WhereRequire
                        <T>("and " + column + " = ", value));
                            return this;
                            }
                            ...
                            */
                            public
                            <T> Assist orEq(String column, T value) {
                                setRequires(new Assist().new WhereRequire
                                <T>("or " + column + " = ", value));
                                    return this;
                                    }
                                    ...
                                    */
                                    public
                                    <T> Assist andNeq(String column, T value) {
                                        setRequires(new Assist().new WhereRequire
                                        <T>("and " + column + " <> ", value));
                                            return this;
                                            }
                                            ...
                                            */
                                            public
                                            <T> Assist orNeq(String column, T value) {
                                                setRequires(new Assist().new WhereRequire
                                                <T>("or " + column + " <> ", value));
                                                    return this;
                                                    }
                                                    ...
                                                    */
                                                    public
                                                    <T> Assist andLt(String column, T value) {
                                                        setRequires(new Assist().new WhereRequire
                                                        <T>("and " + column + "< ", value));
                                                            return this;
                                                            }
                                                            ...
                                                            */
                                                            public
                                                            <T> Assist orLt(String column, T value) {
                                                                setRequires(new Assist().new WhereRequire
                                                                <T>("or " + column + " < ", value));
                                                                    return this;
                                                                    }
                                                                    ...
                                                                    */
                                                                    public
                                                                    <T> Assist andLte(String column, T value) {
                                                                        setRequires(new Assist().new WhereRequire
                                                                        <T>("and " + column + " <= ", value));
                                                                            return this;
                                                                            }
                                                                            ...
                                                                            */
                                                                            public
                                                                            <T> Assist orLte(String column, T value) {
                                                                                setRequires(new Assist().new
                                                                                WhereRequire
                                                                                <T>("or " + column + " <= ", value));
                                                                                    return this;
                                                                                    }
                                                                                    ...
                                                                                    */
                                                                                    public
                                                                                    <T> Assist andGt(String column, T
                                                                                        value) {
                                                                                        setRequires(new Assist().new
                                                                                        WhereRequire
                                                                                        <T>("and " + column + " > ",
                                                                                                                                                            ...
                                                                                                                                                            */
                                                                                                                                                            ...
                                                                                                                                                            <T>
                                                                                                                                                                ...
                                                                                                                                                                <T>
                                                                                                                                                                    ...
                                                                                                                                                                    *
                                                                                                                                                                    --Assist.whereRequire("列名
                                                                                                                                                                    =
                                                                                                                                                                    ",
                                                                                                                                                                    条件值),<br>
                                                                                                                                                                    *
                                                                                                                                                                    --Assist.whereRequire("or
                                                                                                                                                                    列名
                                                                                                                                                                    =
                                                                                                                                                                    ",
                                                                                                                                                                    条件值)<br>
